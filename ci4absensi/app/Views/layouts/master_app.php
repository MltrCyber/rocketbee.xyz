...
<body class="hold-transition light-skin sidebar-mini theme-primary fixed">
    ...
    <div class="wrapper">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu animated flipInX">
                                <li class="user-body">
                                    <a class="dropdown-item" href="<?= base_url('profil') ?>"><i class="ti-user text-muted me-2"></i> Profile</a>
                        ...
                        <ul class="sidebar-menu" data-widget="tree">
                            ...
                            <li class="treeview">
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    <li><a href="karyawan"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Data Karyawan</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="absensimasuk">
                                    <i class="fad fa-user-clock"></i>
                                    <span>Data Absensi Masuk</span>
                                </a>
                            </li>
                            <li>
                                <a href="absensikeluar">
                                    <i class="fad fa-sign-out"></i>
                                    <span>Data Absensi Keluar</span>
                                </a>
                            </li>
                        </ul>
                    </div>
        ...
        <footer class="main-footer">
            &copy; <?= date('Y') ?> <a href="#">E-Absensi</a>. All Rights Reserved.
        </footer>
