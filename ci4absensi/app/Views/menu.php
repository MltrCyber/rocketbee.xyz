...
<div class="screen-1">
    <center><br>
        ...
        <br>
        <?php if ($absenmasuk == 'ada') : ?>
            <a href="#" onclick="udahMasuk()" class="login btn-block mt-2" style="color: black; background-color: #f4b30d;">Absensi Masuk </a>
            <br>
        <?php else : ?>
            <a href="<?= base_url() ?>/home/absensimasuk" class="login btn-block mt-2" style="color: black; background-color: #f4b30d;">Absensi Masuk </a>
            <br>
        <?php endif; ?>
        <?php if ($absenkeluar == 'ada') : ?>
            <a href="#" onclick="udahKeluar()" class="login btn-block mt-2" style="background-color: black; color: #f4b30d;">Absensi Keluar </a>
            <br>
        <?php elseif($absenmasuk == 'belumada'): ?>
            <a href="#" onclick="absendulu()" class="login btn-block mt-2" style="background-color: black; color: #f4b30d;">Absensi Keluar </a>
            <br>
        <?php else : ?>
            <a href="<?= base_url() ?>/home/absensikeluar" class="login btn-block mt-2" style="background-color: black; color: #f4b30d;">Absensi Keluar </a>
            <br>
        <?php endif; ?>
        <a href="<?= base_url() ?>/home/absensisaya" class="login btn-block mt-2" style="color: white; background-color: gray;">Riwayat Absensi </a>
        <br>
        <?php if ($absenmasuk == 'ada') : ?>
            <a href="#" id="pintu" class="login btn-block mt-2"></a>
            <br><br>
        <?php else : ?>
...
<script>
    ...
    function udahMasuk() {
        Swal.fire({
            icon: 'info',
            title: 'Anda telah mengisi Absensi Masuk hari ini',
    ...
    function udahKeluar() {
        Swal.fire({
            icon: 'info',
            title: 'Anda telah mengisi Absensi Keluar hari ini',
            showConfirmButton: false,
            timer: 1500
        })
    }
    ...
    function absendulu() {
        Swal.fire({
            icon: 'info',
            title: 'Silahkan isi Absensi masuk terlebih dahulu',
            showConfirmButton: false,
            timer: 1500
        })
    }
